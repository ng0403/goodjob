    ...
    <div id="css_tabs">
		...
		<div id="tabDiv1" class="tab1_content">
		 <div class="tabBody">
				...
				<table class=table>
					<tbody id="tbody1">
						<form action="organMdfy" method="post" id="joinform">
						<tr class="orgDetail">
						...
						<tr class="orgDetail">
							<th>상위조직ID</th>
							<td><input type="text" name="P_ORG_ID" id="P_ORG_ID" class="int" />
							</td>	
							<th>상위조직명</th>
							<td><input type="text" name="MAIN_GROUND" id="MAIN_GROUND" class="int" />
							</td>	
						...
						<tr class="orgDetail">
							...
							<th>대표사원ID</th>
							<td>
							<input type="text" class="int" name="ORG_LEVEL_CD" id="ORG_LEVEL_CD" />
							</td>
						</tr>
						<tr class="orgDetail">				
							<th>전화번호</th>
							<td>
								<input type="text" name="PHONE_NO" id="PHONE_NO" class="int" maxlength="15" />
							</td>
							<th>팩스번호</th>
							<td>
								<input type="text" name="FAX_NO" id="FAX_NO" class="int" maxlength="15" />
							</td>							
						</tr>						
						<tr class="orgDetail">						
							<th>주소</th>
						...
						<tr class="orgtypeDetail">
							...
							<input type="radio" name="ACTIVE_FLG"  id="ACTIVE_FLG_N" value="N" />&nbsp;N</td>
							<th>&nbsp;</th>
							<td>&nbsp;</td>
						</tr>
						</c:forEach>
					...
					<div class="bt_position_detail">
						...
						<input type="button" class="org_btn" value="저장" id="submitbtn" />

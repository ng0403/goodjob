	...
	<div id="css_tabs">
		...
		<div id="tabDiv1" class="tab1_content">
			<form method="post" id="joinform" >
				<table class="table">
					<tbody id="tbody1">
					 <c:forEach var="employeeCheck" items="${employeeCheck}" >
						<tr> 
							<th>사용자ID</th>
							<td>
							...
							<th>부서번호</th>
							<td><input type="text" value="${employeeCheck.POSITION_CD}" name="POSITION_CD" id="POSITION_CD"
								class="iuser_txt" style="width:90%"></input></td>
						...
						<tr>
							...
							<th>전화번호</th>
							<td><input type="text" value="${employeeCheck.WORK_PHONE_NO}" name="WORK_PHONE_NO" id="WORK_PHONE_NO" class="iuser_txt" maxlength="12" style="width:90%" />   
							</td>
							 
							<th>입사일</th>
							<td><input type="text" value="${employeeCheck.JOIN_DAY}" name="JOIN_DAY" id="JOIN_DAY" class="iuser_txt" maxlength="4" style="width:90%" /> 
 							</td>
							<th>퇴사일</th>
							<td><input type="text" value="${employeeCheck.RETIRE_DAY}" name="RETIRE_DAY" id="RETIRE_DAY" class="iuser_txt" style="width:90%" /> 
 							</td>
 							<th>작성자</th>
							<td><input type="text" value="${employeeCheck.C_USER_ID}" name="C_USER_ID" id="C_USER_ID" class="iuser_txt" style="width:90%" /> 
 							</td> 

...
<script type="text/javascript"
	src="${ctx}/resources/common/js/sales/est/delEstDetail.js"></script>
	...
	<div id="write_est">
		...
		<div id="title">
			<div class="caption">
				<label id="listLabel" class="ui header">■ 견적 > 
					...
					<a href="/delEstInqr" style="font-size: 19px; text-decoration:none; color: black;  font: bold;">삭제된 데이터</a>
					&nbsp;> 삭제된 견적 상세정보
				</label>
			</div>
		</div>
		...
		<div id="tabDiv1" class="tab1_content">
			<div id="baseBtnDiv" class="bt_position_authuser">
				<input type="button" id="restoreEstBtn" class="tiny ui blue button" value="복원" onclick="restoreEstBtn('${detail.estim_id}');"/>
				<input type="button" id="delEstDelBtn" class="tiny ui blue button" value="삭제" onclick="deEstDelBtn('${detail.estim_id}');"/>
				<input type="button" id="delEstCancelBtn" class="tiny ui button" value="취소" onclick="delCancel_Click();"/>
			</div>

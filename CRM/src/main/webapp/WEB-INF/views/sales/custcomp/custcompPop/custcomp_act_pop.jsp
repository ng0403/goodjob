...
<!-- 								<input type="button" id="customer" value="고객"></td> -->
					...
					<tr>
						...
						<td>
						    ...
						    <input type="text"   id="sales_oppt_nm" name="sales_oppt_nm" class="int" value="${detail.sales_oppt_nm}" readonly="readonly" > 
						    <input type="button" id="act_opp_nm"    name="act_opp" 		 class="cust_act_btn" value="영업기회"   onclick="ccOpptListPop('${ctx}');">
						</td>
					</tr>
					<tr>
						<th>영업활동구분</th>
					...
					<tr>
					 ...
					 <tr>
					 	<th>시작시간</th>
					 	<td><select name="strt_t" id="strt_t_h" class="start_hour">
					...
					<tr>
						<th>종료시간</th>
						<td><select name="ent_t" id="end_t_h" class="end_hour">
								<option value="0" style="text-align: center;">==선택==</option>
								<option value="01">1</option>
								<option value="02">2</option>
								<option value="03">3</option>

...
<body onload='javscript:if(${flg eq "detail"}) ccActDetailSelect();'>
...
<!-- 								<input type="button" id="customer" value="고객"></td> -->
						...
						<tr>
							...
							<td>
							    ...
							    <input type="text" name="sales_oppt_nm" id="sales_oppt_nm" class="int" value="${detail.sales_oppt_nm}" readonly="readonly" onclick="actOpptListPopup();"> 

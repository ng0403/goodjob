...
function prodList(ctx){
	window.open(ctx+'/custEstProdList','newwindow3','width=770, height=340, toolbar=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no');
}

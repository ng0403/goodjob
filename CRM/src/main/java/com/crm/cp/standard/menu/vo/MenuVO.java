package com.crm.cp.standard.menu.vo;
...
public class MenuVO {
	...
	public MenuVO(String menu_lev, String id_nm) {
		super();
	...
	public MenuVO(String menu_id, String menu_nm, String menu_url,
			String menu_lev, String up_menu_id, String deflt_yn,
			String creat_yn, String mdfy_yn, String del_yn, String retrv_yn, ArrayList<MenuVO> menuVO) {
		super();
	...
	public String toString() {
		return "MenuVO [menu_id=" + menu_id + ", menu_nm=" + menu_nm
				...
				+ ", auth_id=" + auth_id + ", iuser_id=" + iuser_id
				+ ", id_nm=" + id_nm + ", menuVO=" + menuVO + "]";
	}
